    ...
    for comparator in (HISTORICAL, BOOTSTRAP):
        ...
        for _, row in merged.iterrows():
            rows.append({
                ...
                "volatility_difference": (row["annual_volatility_candidate"] -
...
def analyze(args: argparse.Namespace) -> dict[str, Any]:
    ...
    try:
        ...
        result = {
            ...
            "operational_revision": "v1_1_metric_column_name_correction",
            ...
            "scientific_note": (
                ...
                "holdout and remains explanatory. The v1.1 operational revision only "
                "corrects the metrics() output name annual_volatility in matched-seed "
                "reporting; no return, weight, model, contrast, or inference rule changed."),
        }
