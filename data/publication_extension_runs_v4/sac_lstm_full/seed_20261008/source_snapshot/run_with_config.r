...
Sys.setenv(PRETRAIN_RANDOM_EXPLORATION_STEPS = as.character(config$pretraining$random_exploration_steps))
Sys.setenv(PRETRAIN_BEHAVIOR_GATE_WINDOW = as.character(config$pretraining$behavior_gate_window))
