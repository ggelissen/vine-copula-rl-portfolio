...
NO_VINE_SWEEP_ROOT='data/no_vine_rl_runs_secondary_v3' RSCRIPT="$RSCRIPT" PYTHON="$PYTHON" \
...
"$PYTHON" publication_pipeline_draft/diagnostic_artifacts.py \
  --rl-runs 'data/no_vine_rl_runs_secondary_v3' --expected-seeds 10 \
...
"$PYTHON" publication_pipeline_draft/freeze_training_release.py \
  --repo-root . --rl-runs 'data/no_vine_rl_runs_secondary_v3' \
