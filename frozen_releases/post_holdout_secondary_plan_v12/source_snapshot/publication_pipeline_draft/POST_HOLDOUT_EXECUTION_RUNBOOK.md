...
/gabirel/miniforge3/bin/python3 \
  ...
  --output frozen_releases/post_holdout_secondary_plan_v12 \
  --bundle frozen_releases/post_holdout_secondary_plan_v12.tar.gz

(cd frozen_releases && \
  sha256sum -c post_holdout_secondary_plan_v12.tar.gz.sha256)
(cd frozen_releases/post_holdout_secondary_plan_v12 && \
...
/gabirel/miniforge3/bin/python3 \
  ...
  --secondary-plan-release frozen_releases/post_holdout_secondary_plan_v12 \
