...
# Replay-v2 paths deliberately preserve the failed, zero-output replay and its
# original analysis-plan release.  The checkpoint audit is unchanged and is
# reused as the authoritative 130-checkpoint gate.
PLAN_RELEASE=frozen_releases/causal_analysis_v2_v3_v4_replay_v2
AUDIT=analysis_outputs/causal_sweep_audit_v2_v3_v4
WEIGHTS=analysis_outputs/causal_policy_weights_v2_v3_v4_retry1
ENSEMBLES=analysis_outputs/causal_policy_ensembles_v2_v3_v4_replay_v2
INTERFACE=analysis_outputs/causal_evaluation_interface_v2_v3_v4_replay_v2
ACCOUNTING=analysis_outputs/causal_common_accounting_v2_v3_v4_replay_v2
PANEL=analysis_outputs/causal_strategy_periods_v2_v3_v4_replay_v2.csv
RESULTS=analysis_outputs/causal_analysis_results_v2_v3_v4_replay_v2
RESULT_RELEASE=frozen_releases/causal_results_v2_v3_v4_replay_v2
...
freeze_plan() {
  ...
  (cd frozen_releases && sha256sum -c causal_analysis_v2_v3_v4_replay_v2.tar.gz.sha256)
}
...
freeze_results() {
  ...
  (cd frozen_releases && sha256sum -c causal_results_v2_v3_v4_replay_v2.tar.gz.sha256)
}
