...
PLAN_RELEASE=frozen_releases/causal_analysis_v2_v3_v4_accounting_v2
...
INTERFACE=analysis_outputs/causal_evaluation_interface_v2_v3_v4_accounting_v2
ACCOUNTING=analysis_outputs/causal_common_accounting_v2_v3_v4_accounting_v2
PANEL=analysis_outputs/causal_strategy_periods_v2_v3_v4_accounting_v2.csv
RESULTS=analysis_outputs/causal_analysis_results_v2_v3_v4_accounting_v2
RESULT_RELEASE=frozen_releases/causal_results_v2_v3_v4_accounting_v2
...
freeze_plan() {
  ...
  (cd frozen_releases && sha256sum -c causal_analysis_v2_v3_v4_accounting_v2.tar.gz.sha256)
}
...
freeze_results() {
  ...
  (cd frozen_releases && sha256sum -c causal_results_v2_v3_v4_accounting_v2.tar.gz.sha256)
}
