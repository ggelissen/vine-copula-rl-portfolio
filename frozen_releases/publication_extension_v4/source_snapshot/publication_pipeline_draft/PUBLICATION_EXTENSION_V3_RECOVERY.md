...
The frozen v2 manifest is the authoritative attestation for these immutable
alternative-pretraining bundles.  Using it prevents a synchronized convenience
manifest from silently redefining the v3 training inputs.
